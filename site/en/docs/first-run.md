...
Use them as they are or remove them. From a column's header you can reorder, resize and remove it, and "Add column" (カラム追加, +) lets you add the notifications, search, chat or other columns you need. For what can go where, see [Columns and windows](/docs/deck/columns) (Japanese).
...
API keys are stored in the OS keychain and never written into settings files. For details, see [Using AI](/docs/guide/ai) (Japanese).

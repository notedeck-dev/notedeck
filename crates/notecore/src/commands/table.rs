...
macro_rules! with_command_table {
    ($cb:ident) => {
        ...
        data capability_execute(id: String, params: serde_json::Value, principal: String, account_id: Option<String>, tainted: bool) -> $crate::capabilities::exec::ExecOutcome = $crate::commands::ai_chat::capability_execute;
        data capability_preview(id: String, params: serde_json::Value, principal: String, account_id: Option<String>, tainted: bool) -> Option<serde_json::Value> = $crate::commands::ai_chat::capability_preview;

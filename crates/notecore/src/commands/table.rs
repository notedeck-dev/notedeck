...
macro_rules! with_command_table {
    ($cb:ident) => {
        ...
        data capability_preview(id: String, params: serde_json::Value, principal: String, account_id: Option<String>) -> Option<serde_json::Value> = $crate::commands::ai_chat::capability_preview;

...
macro_rules! with_command_table {
    ($cb:ident) => {
        ...
        data capability_execute(id: String, params: serde_json::Value, principal: String, account_id: Option<String>, tainted: bool, plugin_id: Option<String>) -> $crate::capabilities::exec::ExecOutcome = $crate::commands::ai_chat::capability_execute;
